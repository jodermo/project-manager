...
export class ClientDeviceService extends ClientDeviceCoordinate {
  ...
  devicePositionUpdates = 0;
  deviceRotationUpdates = 0;
  private initialClick = false;
  ...
  lookAt(anchor: any, point: any) {
    return Math.atan2(anchor.longitude - point.longitude, anchor.latitude - point.latitude) * 180 / Math.PI + 180;
  }
